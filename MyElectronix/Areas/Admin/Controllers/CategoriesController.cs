...
namespace MyElectronix.Areas.Admin.Controllers
{
    public class CategoriesController : BaseController
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "CategoryId,CategoryName,CategoryDescription,IsActive,MainCategoryId")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "CategoryId,CategoryName,CategoryDescription,IsActive,MainCategoryId")] Category category)
        {
            if (ModelState.IsValid)
            {
